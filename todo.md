...
## Configuração de Email de Notificações por Admin (Sprint Atual)

- [x] Adicionar campo emailNotificacao na tabela users
- [x] Criar interface de configuração de email em Configuracoes.tsx
- [x] Implementar salvamento de email de notificação
- [x] Alterar notificationRouter para usar email configurado
- [x] Testar fluxo completo de notificações com email configurado
